...
public class Principal {
	...
	private static void get(Docentes docentes1) {
	...
	static public void menuD(Docentes doce) {
		...
		do {
			...
			switch (op) {
			case 1:
				doce.Calificar(g5, doce);
				break;
			case 2:
				doce.Dictar(g5, doce);
				break;
			case 3:
				doce.Regañar(g5, doce);
				break;
			case 4:
				System.out.println("Usted a salido del programa");
				System.exit(0);
	...
	static public void menuA(Administrativos trece) {
		...
		do {
			...
			System.out.println("-----------METODOS-----------");
			System.out.println("1.Documentar\n2.Archivando\n3.Comiendo\n4.Salir");
			System.out.print("Ingresa una opcion:");
			op = txt.nextInt();
			int a=0, b=0, c1=0;
			switch (op) {
			case 1:
				trece.documentacion(a, trece);
				break;
			case 2:
				trece.archivando(b, trece);
				break;
			case 3:
				trece.comiendo(c1, trece);
				break;
			case 4:
				System.out.println("Usted a salido del programa");
				System.exit(0);
		...
		do {
			...
			System.out.println("-----------METODOS-----------");
			System.out.println("1.Organizar\n2.trabajar\n3.discurso\n4.Salir");
			System.out.print("Ingresa una opcion:");
			op = txt.nextInt();
			int c = 0, f = 0, g = 0;
			switch (op) {
			case 1:
				catorce.organizar(c, catorce);
				break;
			case 2:
				catorce.trabajar(f, catorce);
				break;
			case 3:
				catorce.discurso(g, catorce);
				break;
			case 4:
				System.out.println("Usted a salido del programa");
				System.exit(0);
