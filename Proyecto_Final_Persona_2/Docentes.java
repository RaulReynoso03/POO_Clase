...
public class Docentes extends Persona {
	...
	public int Dictar(int dictar, Docentes a) {
		System.out.println("El maestro esta dictando");
		return dictar;
	}

	public int Calificar(int calificar, Docentes a) {
		System.out.println("El maestro esta calificando");
		return calificar;
	}

	public int Regañar(int regañar, Docentes a) {
		System.out.println("El maestro esta regañando a su grupo");
		return regañar;
	}
}
